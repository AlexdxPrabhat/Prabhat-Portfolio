...
export const experiences = [
  {
    id: 0,
    img: accenture,
    role: "Package App Development Associate",
    company: "Accenture Solutions Private Limited",
    date: "Oct 2024 - Present",
    desc: "Supporting IT operations and service management using ServiceNow and ITIL processes. Leveraging Excel, Python, and cloud skills for automation, reporting, and compliance tasks while collaborating with global teams in an agile setup.",
    skills: [
      "ServiceNow",
      "ITIL",
      "ITSM",
